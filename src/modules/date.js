function getDomElem(){
    ...
    const arrayDomElement = {form: form, inputs: inputs, typeFundamenta: typeFundamenta,typeFundamentaLent: typeFundamentaLent, typeFundamentaSV: typeFundamentaSV, typeSV: typeSV, options: options, select: select, materialType: materialType, areaElement: areaElement,  totalConsumptionElement: totalConsumptionElement,  quantityElement: quantityElement,areaElement1: areaElement1, label: label, formatterInt: formatterInt, arrValue: arrValue, totalTran: totalTran, description: description}
