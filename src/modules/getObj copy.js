...
function addObjParam() {
    ...
    let newObject = [
        {
            'Ширина фундамента (A), м': obj.a,
            'Длина фундамента (B), м': obj.b,
            'Высота фундамента (C), м': obj.c,
        ...
        {           
            ...
            'Досок на опалубку (+10%), шт': obj.objOpalubka,
            'Объем траншеи в м3': obj.objTransh,
